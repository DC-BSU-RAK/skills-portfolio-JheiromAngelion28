...
class StudentManagerApp:
    def __init__(self, root):
        ...
        # Main content frame (combine header and content)
        ...
        self.header_frame = ctk.CTkFrame(self.main_frame, height=70, corner_radius=0)
        ...
        self.content_frame.grid(row=1, column=0, sticky="nswe", padx=0, pady=0)
        ...
        sidebar_title.grid(row=0, column=0, padx=15, pady=(20,15), sticky="w")
        ...
        self.btn_view_all.grid(row=1, column=0, padx=15, pady=8, sticky="we")
        ...
        self.btn_individual.grid(row=2, column=0, padx=15, pady=8, sticky="we")
        ...
        self.btn_add.grid(row=3, column=0, padx=15, pady=8, sticky="we")
        ...
        self.btn_update.grid(row=4, column=0, padx=15, pady=8, sticky="we")
        ...
        self.btn_delete.grid(row=5, column=0, padx=15, pady=8, sticky="we")
        ...
        self.btn_sort.grid(row=6, column=0, padx=15, pady=8, sticky="we")
        ...
        self.btn_refresh.grid(row=7, column=0, padx=15, pady=8, sticky="we")
        ...
        self.theme_toggle.grid(row=10, column=0, padx=15, pady=(10,20), sticky="we")
    ...
    def create_student_card(self, parent, student):
        ...
        ctk.CTkLabel(
            card, 
            text=f"Code: {student.student_code}", 
        ...
        ctk.CTkLabel(
            ...
            text_color=grade_colors.get(student.grade, "#FFFFFF")
        ).grid(row=3, column=0, sticky="w", padx=15, pady=(2,12))
    ...
    def display_students_cards(self, students, title="Students"):
        ...
        if not students:
            ...
            no_data_label.grid(row=1, column=0, pady=30, sticky="w")
            return
        ...
        for c in range(cols):
            scrollable_frame.grid_columnconfigure(c, weight=1, minsize=250)
    ...
    def show_welcome(self):
        ...
        welcome_frame = ctk.CTkFrame(self.content_frame, corner_radius=0)
        welcome_frame.pack(fill="both", expand=True, padx=40, pady=40)

        ctk.CTkLabel(
            welcome_frame, 
            text="Welcome to Student Manager", 
    ...
    def add_student_dialog(self):
        ...
        for i,text in enumerate(labels):
            ctk.CTkLabel(dialog, text=text, font=ctk.CTkFont(size=13)).grid(row=i, column=0, padx=15, pady=8, sticky="w")
            e = ctk.CTkEntry(dialog, width=200)
            e.grid(row=i, column=1, padx=15, pady=8)
            entries.append(e)

        def submit():
            if not all(entries[i].get() for i in [0,1]):
        ...
        ctk.CTkButton(
            ...
            command=submit, 
            height=40
        ).grid(row=6, column=0, columnspan=2, padx=15, pady=20, sticky="we")
    ...
    def update_student_dialog(self):
        ...
        ctk.CTkButton(
            ...
            command=submit, 
            height=40
        ).grid(row=5, column=0, columnspan=2, padx=15, pady=20, sticky="we")
